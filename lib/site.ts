...
export const categories: Category[] = [
  {
    ...
    toolCountLabel: { ko: "7개 사용 가능", en: "7 available", ja: "7件利用可能" },
    accent: "#0868D7",
  },
  {
    slug: "image-edit",
  ...
  },
  {
    ...
    toolCountLabel: { ko: "9개 사용 가능", en: "9 available", ja: "9件利用可能" },
    accent: "#0868D7",
  },
  {
    slug: "date-time",
...
export const tool077Slug = "investment-return-calculator" as const;
...
export const tool077Titles: Record<Locale, string> = { ko: "투자수익률 계산기", en: "Investment Return Calculator", ja: "投資収益率計算ツール" };
export const tool077Descriptions: Record<Locale, string> = { ko: "매입금액·현재 평가금·보유기간으로 총 수익률과 연환산수익률을 계산합니다.", en: "Calculate total return and annualized return from purchase amount, current value, and holding period.", ja: "購入金額・現在評価額・保有期間から収益率と年率換算収益率を計算します。" };
export const tool078Titles: Record<Locale, string> = { ko: "주식 평균단가 계산기", en: "Stock Average Cost Calculator", ja: "株式平均取得単価計算ツール" };
export const tool078Descriptions: Record<Locale, string> = { ko: "기존 보유 수량·단가와 여러 번의 추가 매수를 가중평균해 평균단가와 목표 매도가를 계산합니다.", en: "Calculate weighted average stock cost and target sell price from existing shares and additional purchases.", ja: "既存保有株数・単価と追加購入から加重平均取得単価と目標売却価格を計算します。" };
export const tool079Titles: Record<Locale, string> = { ko: "배당수익률 계산기", en: "Dividend Yield Calculator", ja: "配当利回り計算ツール" };
...
export const tool082Titles: Record<Locale, string> = { ko: "건폐율·용적률 계산기", en: "Building Coverage & Floor Area Ratio Calculator", ja: "建蔽率・容積率計算ツール" };
export const tool082Descriptions: Record<Locale, string> = { ko: "대지면적·건축면적·연면적으로 건폐율과 용적률을 계산하고 목표 비율의 가능 면적을 역산합니다.", en: "Calculate building coverage and floor area ratio, then reverse-calculate possible areas from target ratios.", ja: "敷地・建築・延べ床面積から建蔽率・容積率を計算し、目標比率から可能面積を逆算します。" };
export const tool083Titles: Record<Locale, string> = { ko: "방·벽·천장 면적 계산기", en: "Room, Wall & Ceiling Area Calculator", ja: "部屋・壁・天井面積計算ツール" };
...
const categoryToolPresets: Record<string, ToolCardData[]> = {
  ...
  "business-finance": [
    ...
    {
      title: tool077Titles,
      description: tool077Descriptions,
      href: `/${"ko"}/${tool077Slug}`,
      status: "LIVE",
      active: true,
    },
    {
      title: tool078Titles,
      description: tool078Descriptions,
      href: `/${"ko"}/${tool078Slug}`,
      status: "LIVE",
      active: true,
    },
    {
      title: tool079Titles,
      description: tool079Descriptions,
      href: `/${"ko"}/${tool079Slug}`,
      status: "LIVE",
      active: true,
    },
    {
      title: tool080Titles,
      description: tool080Descriptions,
      href: `/${"ko"}/${tool080Slug}`,
      status: "LIVE",
      active: true,
    },
  ...
  "real-estate-build": [
    ...
    {
      title: tool082Titles,
      description: tool082Descriptions,
      href: `/${"ko"}/${tool082Slug}`,
      status: "LIVE",
      active: true,
    },
    {
      title: tool083Titles,
      description: tool083Descriptions,
      href: `/${"ko"}/${tool083Slug}`,
      status: "LIVE",
      active: true,
    },
    {
      title: tool084Titles,
      description: tool084Descriptions,
      href: `/${"ko"}/${tool084Slug}`,
      status: "LIVE",
      active: true,
    },
...
export function getCategoryToolCards(categorySlug: string, locale: Locale): ToolCardData[] {
  ...
  if (categorySlug === "business-finance") {
    return cards.map((item, index) =>
      ...
      index === 10 ? { ...item, href: `/${locale}/${tool076Slug}` } :
      index === 11 ? { ...item, href: `/${locale}/${tool077Slug}` } :
      index === 12 ? { ...item, href: `/${locale}/${tool078Slug}` } :
      index === 13 ? { ...item, href: `/${locale}/${tool079Slug}` } :
      index === 14 ? { ...item, href: `/${locale}/${tool080Slug}` } : item
    );
  }
...
export const publicTools = [
  { number: 1, slug: tool001Slug, titles: tool001Titles, category: "image-convert" },
  { number: 2, slug: tool002Slug, titles: tool002Titles, category: "image-convert" },
  { number: 3, slug: tool003Slug, titles: tool003Titles, category: "image-convert" },
  { number: 4, slug: tool004Slug, titles: tool004Titles, category: "image-convert" },
  { number: 5, slug: tool005Slug, titles: tool005Titles, category: "image-convert" },
  { number: 6, slug: tool006Slug, titles: tool006Titles, category: "image-convert" },
  { number: 7, slug: tool007Slug, titles: tool007Titles, category: "image-convert" },
  { number: 8, slug: tool008Slug, titles: tool008Titles, category: "image-edit" },
  { number: 9, slug: tool009Slug, titles: tool009Titles, category: "image-edit" },
  { number: 10, slug: tool010Slug, titles: tool010Titles, category: "image-edit" },
  { number: 11, slug: tool011Slug, titles: tool011Titles, category: "image-edit" },
  { number: 12, slug: tool012Slug, titles: tool012Titles, category: "image-edit" },
  { number: 13, slug: tool013Slug, titles: tool013Titles, category: "image-edit" },
  { number: 14, slug: tool014Slug, titles: tool014Titles, category: "image-edit" },
  { number: 15, slug: tool015Slug, titles: tool015Titles, category: "image-edit" },
  { number: 16, slug: tool016Slug, titles: tool016Titles, category: "image-edit" },
  { number: 17, slug: tool017Slug, titles: tool017Titles, category: "image-edit" },
  { number: 18, slug: tool018Slug, titles: tool018Titles, category: "image-edit" },
  { number: 19, slug: tool019Slug, titles: tool019Titles, category: "content-image" },
  { number: 20, slug: tool020Slug, titles: tool020Titles, category: "content-image" },
  { number: 21, slug: tool021Slug, titles: tool021Titles, category: "content-image" },
  { number: 22, slug: tool022Slug, titles: tool022Titles, category: "content-image" },
  { number: 23, slug: tool023Slug, titles: tool023Titles, category: "content-image" },
  { number: 24, slug: tool024Slug, titles: tool024Titles, category: "content-image" },
  { number: 25, slug: tool025Slug, titles: tool025Titles, category: "content-image" },
  { number: 26, slug: tool026Slug, titles: tool026Titles, category: "pdf" },
  { number: 27, slug: tool027Slug, titles: tool027Titles, category: "pdf" },
  { number: 28, slug: tool028Slug, titles: tool028Titles, category: "pdf" },
  { number: 29, slug: tool029Slug, titles: tool029Titles, category: "pdf" },
  { number: 30, slug: tool030Slug, titles: tool030Titles, category: "pdf" },
  { number: 31, slug: tool031Slug, titles: tool031Titles, category: "pdf" },
  { number: 32, slug: tool032Slug, titles: tool032Titles, category: "pdf" },
  { number: 33, slug: tool033Slug, titles: tool033Titles, category: "pdf" },
  { number: 34, slug: tool034Slug, titles: tool034Titles, category: "pdf" },
  { number: 35, slug: tool035Slug, titles: tool035Titles, category: "pdf" },
  { number: 36, slug: tool036Slug, titles: tool036Titles, category: "text" },
  { number: 37, slug: tool037Slug, titles: tool037Titles, category: "text" },
  { number: 38, slug: tool038Slug, titles: tool038Titles, category: "text" },
  { number: 39, slug: tool039Slug, titles: tool039Titles, category: "text" },
  { number: 40, slug: tool040Slug, titles: tool040Titles, category: "text" },
  { number: 41, slug: tool041Slug, titles: tool041Titles, category: "text" },
  { number: 42, slug: tool042Slug, titles: tool042Titles, category: "text" },
  { number: 43, slug: tool043Slug, titles: tool043Titles, category: "text" },
  { number: 44, slug: tool044Slug, titles: tool044Titles, category: "text" },
  { number: 45, slug: tool045Slug, titles: tool045Titles, category: "date-time" },
  { number: 46, slug: tool046Slug, titles: tool046Titles, category: "date-time" },
  { number: 47, slug: tool047Slug, titles: tool047Titles, category: "date-time" },
  { number: 48, slug: tool048Slug, titles: tool048Titles, category: "date-time" },
  { number: 49, slug: tool049Slug, titles: tool049Titles, category: "date-time" },
  { number: 50, slug: tool050Slug, titles: tool050Titles, category: "date-time" },
  { number: 51, slug: tool051Slug, titles: tool051Titles, category: "date-time" },
  { number: 52, slug: tool052Slug, titles: tool052Titles, category: "date-time" },
  { number: 53, slug: tool053Slug, titles: tool053Titles, category: "date-time" },
  { number: 54, slug: tool054Slug, titles: tool054Titles, category: "date-time" },
  { number: 55, slug: tool055Slug, titles: tool055Titles, category: "unit-calc" },
  { number: 56, slug: tool056Slug, titles: tool056Titles, category: "unit-calc" },
  { number: 57, slug: tool057Slug, titles: tool057Titles, category: "unit-calc" },
  { number: 58, slug: tool058Slug, titles: tool058Titles, category: "unit-calc" },
  { number: 59, slug: tool059Slug, titles: tool059Titles, category: "unit-calc" },
  { number: 60, slug: tool060Slug, titles: tool060Titles, category: "unit-calc" },
  { number: 61, slug: tool061Slug, titles: tool061Titles, category: "unit-calc" },
  { number: 62, slug: tool062Slug, titles: tool062Titles, category: "unit-calc" },
  { number: 63, slug: tool063Slug, titles: tool063Titles, category: "unit-calc" },
  { number: 64, slug: tool064Slug, titles: tool064Titles, category: "unit-calc" },
  { number: 65, slug: tool065Slug, titles: tool065Titles, category: "unit-calc" },
  { number: 66, slug: tool066Slug, titles: tool066Titles, category: "business-finance" },
  { number: 67, slug: tool067Slug, titles: tool067Titles, category: "business-finance" },
  { number: 68, slug: tool068Slug, titles: tool068Titles, category: "business-finance" },
  ...
  { number: 77, slug: tool077Slug, titles: tool077Titles, category: "business-finance" },
