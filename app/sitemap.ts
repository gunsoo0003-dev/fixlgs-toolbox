...
const baseUrl = "https://www.fixlgs.com/tools";
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  for (const locale of locales) {
    ...
    for (const category of categories.slice(0, 9)) {
      entries.push({
    ...
    entries.push({ url: `${baseUrl}/${locale}/${tool077Slug}`, changeFrequency: "weekly", priority: 0.95 });
    entries.push({ url: `${baseUrl}/${locale}/${tool078Slug}`, changeFrequency: "weekly", priority: 0.95 });
    entries.push({ url: `${baseUrl}/${locale}/${tool079Slug}`, changeFrequency: "weekly", priority: 0.95 });
    entries.push({ url: `${baseUrl}/${locale}/${tool080Slug}`, changeFrequency: "weekly", priority: 0.95 });
    entries.push({ url: `${baseUrl}/${locale}/${tool081Slug}`, changeFrequency: "weekly", priority: 0.95 });
