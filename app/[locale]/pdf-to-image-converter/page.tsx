...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const canonical = `https://www.fixlgs.com/tools/${current}/pdf-to-image-converter`;
  return {
    ...
    alternates: {
      canonical,
      languages: {
        ko: "https://www.fixlgs.com/tools/ko/pdf-to-image-converter",
        en: "https://www.fixlgs.com/tools/en/pdf-to-image-converter",
        ja: "https://www.fixlgs.com/tools/ja/pdf-to-image-converter",
        "x-default": "https://www.fixlgs.com/tools/en/pdf-to-image-converter",
      },
    },
