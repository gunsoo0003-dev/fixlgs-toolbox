...
export async function generateMetadata({params}:{params:Promise<{locale:string}>}):Promise<Metadata>{const {locale}=await params;if(!locales.includes(locale as Locale))return{};const l=locale as Locale,path=`https://www.fixlgs.com/tools/${l}/deposit-savings-calculator`;return{title:meta[l].title,description:meta[l].description,alternates:{canonical:path,languages:{ko:'https://www.fixlgs.com/tools/ko/deposit-savings-calculator',en:'https://www.fixlgs.com/tools/en/deposit-savings-calculator',ja:'https://www.fixlgs.com/tools/ja/deposit-savings-calculator','x-default':'https://www.fixlgs.com/tools/ko/deposit-savings-calculator'}}}}
