      ...
      <section className="toolbox-subpage-tools">
        ...
        <div className="toolbox-subpage-card-grid">
          {toolCards.map((tool, index) => {
            const toolNumber = categorySlug === "image-edit" ? index + 8 : categorySlug === "content-image" ? index + 19 : categorySlug === "pdf" ? index + 26 : categorySlug === "text" ? index + 36 : index + 1;
            ...
            const body = (
              <>
                <div className="toolbox-subpage-card-top"><span>{(categorySlug === "content-image" || categorySlug === "pdf" || categorySlug === "text") ? String(toolNumber).padStart(3, "0") : String(toolNumber).padStart(2, "0")}</span><small>{tool.active ? "LIVE" : "NEXT"}</small></div>
