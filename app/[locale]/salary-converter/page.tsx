...
export async function generateMetadata({params}:{params:Promise<{locale:string}>}):Promise<Metadata>{const {locale}=await params;if(!locales.includes(locale as Locale))return{};const l=locale as Locale,path=`https://fixlgs.com/tools/${l}/salary-converter`;return{title:meta[l].title,description:meta[l].description,alternates:{canonical:path,languages:{ko:'https://fixlgs.com/tools/ko/salary-converter',en:'https://fixlgs.com/tools/en/salary-converter',ja:'https://fixlgs.com/tools/ja/salary-converter','x-default':'https://fixlgs.com/tools/ko/salary-converter'}}}}
