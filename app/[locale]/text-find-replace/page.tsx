...
export async function generateMetadata({params}:{params:Promise<{locale:string}>}):Promise<Metadata>{const {locale}=await params;if(!locales.includes(locale as Locale))notFound();const l=locale as Locale;const canonical=`https://www.fixlgs.com/tools/${l}/text-find-replace`;return{title:title[l],description:description[l],alternates:{canonical,languages:{ko:`https://www.fixlgs.com/tools/ko/text-find-replace`,en:`https://www.fixlgs.com/tools/en/text-find-replace`,ja:`https://www.fixlgs.com/tools/ja/text-find-replace`,"x-default":`https://www.fixlgs.com/tools/ko/text-find-replace`}},openGraph:{title:title[l],description:description[l],url:canonical,type:"website"}};}
