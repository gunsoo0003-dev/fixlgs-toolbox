...
export async function generateMetadata({params}:{params:Promise<{locale:string}>}):Promise<Metadata>{
 ...
 const l=locale as Locale,path=`https://www.fixlgs.com/tools/${l}/date-add-subtract-calculator`;
 return{title:meta[l].title,description:meta[l].description,alternates:{canonical:path,languages:{ko:"https://www.fixlgs.com/tools/ko/date-add-subtract-calculator",en:"https://www.fixlgs.com/tools/en/date-add-subtract-calculator",ja:"https://www.fixlgs.com/tools/ja/date-add-subtract-calculator","x-default":"https://www.fixlgs.com/tools/ko/date-add-subtract-calculator"}}};
}
