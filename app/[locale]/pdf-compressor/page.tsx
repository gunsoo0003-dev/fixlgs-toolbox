...
export async function generateMetadata({params}:{params:Promise<{locale:string}>}):Promise<Metadata>{const {locale}=await params;if(!locales.includes(locale as Locale))notFound();const l=locale as Locale;const canonical=`https://www.fixlgs.com/tools/${l}/pdf-compressor`;return{title:title[l],description:description[l],alternates:{canonical,languages:{ko:"https://www.fixlgs.com/tools/ko/pdf-compressor",en:"https://www.fixlgs.com/tools/en/pdf-compressor",ja:"https://www.fixlgs.com/tools/ja/pdf-compressor","x-default":"https://www.fixlgs.com/tools/ko/pdf-compressor"}},openGraph:{title:title[l],description:description[l],url:canonical,type:"website"}}}
