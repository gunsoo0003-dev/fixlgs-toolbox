...
export async function generateMetadata({params}:{params:Promise<{locale:string}>}):Promise<Metadata>{const {locale}=await params;if(!locales.includes(locale as Locale))notFound();const l=locale as Locale;const canonical=`https://www.fixlgs.com/tools/${l}/blog-open-graph-image-maker`;return {title:title[l],description:desc[l],alternates:{canonical,languages:{ko:'https://www.fixlgs.com/tools/ko/blog-open-graph-image-maker',en:'https://www.fixlgs.com/tools/en/blog-open-graph-image-maker',ja:'https://www.fixlgs.com/tools/ja/blog-open-graph-image-maker','x-default':'https://www.fixlgs.com/tools/ko/blog-open-graph-image-maker'}},openGraph:{title:title[l],description:desc[l],url:canonical,type:'website'}}}
