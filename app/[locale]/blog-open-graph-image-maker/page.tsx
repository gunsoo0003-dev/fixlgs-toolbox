...
export async function generateMetadata({params}:{params:Promise<{locale:string}>}):Promise<Metadata>{const {locale}=await params;if(!locales.includes(locale as Locale))notFound();const l=locale as Locale;const canonical=`https://fixlgs.com/tools/${l}/blog-open-graph-image-maker`;return {title:title[l],description:desc[l],alternates:{canonical,languages:{ko:'https://fixlgs.com/tools/ko/blog-open-graph-image-maker',en:'https://fixlgs.com/tools/en/blog-open-graph-image-maker',ja:'https://fixlgs.com/tools/ja/blog-open-graph-image-maker','x-default':'https://fixlgs.com/tools/ko/blog-open-graph-image-maker'}},openGraph:{title:title[l],description:desc[l],url:canonical,type:'website'}}}
