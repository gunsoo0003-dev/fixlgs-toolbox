...
export async function generateMetadata({params}:{params:Promise<{locale:string}>}):Promise<Metadata>{const {locale}=await params;if(!locales.includes(locale as Locale))return{};const l=locale as Locale,path=`https://fixlgs.com/tools/${l}/discount-price-calculator`;return{title:meta[l].title,description:meta[l].description,alternates:{canonical:path,languages:{ko:'https://fixlgs.com/tools/ko/discount-price-calculator',en:'https://fixlgs.com/tools/en/discount-price-calculator',ja:'https://fixlgs.com/tools/ja/discount-price-calculator','x-default':'https://fixlgs.com/tools/ko/discount-price-calculator'}}}}
