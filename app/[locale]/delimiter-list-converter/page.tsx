...
export async function generateMetadata({params}:{params:Promise<{locale:string}>}):Promise<Metadata>{const {locale}=await params;if(!locales.includes(locale as Locale))notFound();const l=locale as Locale;const canonical=`https://fixlgs.com/tools/${l}/delimiter-list-converter`;return{title:title[l],description:description[l],alternates:{canonical,languages:{ko:"https://fixlgs.com/tools/ko/delimiter-list-converter",en:"https://fixlgs.com/tools/en/delimiter-list-converter",ja:"https://fixlgs.com/tools/ja/delimiter-list-converter","x-default":"https://fixlgs.com/tools/ko/delimiter-list-converter"}},openGraph:{title:title[l],description:description[l],url:canonical,type:"website"}};}
