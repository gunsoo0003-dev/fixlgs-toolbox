...
export async function generateMetadata({params}:{params:Promise<{locale:string}>}):Promise<Metadata>{const {locale}=await params;if(!locales.includes(locale as Locale))notFound();const l=locale as Locale;const canonical=`https://www.fixlgs.com/tools/${l}/text-extractor`;return{title:title[l],description:description[l],alternates:{canonical,languages:{ko:"https://www.fixlgs.com/tools/ko/text-extractor",en:"https://www.fixlgs.com/tools/en/text-extractor",ja:"https://www.fixlgs.com/tools/ja/text-extractor","x-default":"https://www.fixlgs.com/tools/ko/text-extractor"}},openGraph:{title:title[l],description:description[l],url:canonical,type:"website"}}}
