...
export async function generateMetadata({params}:{params:Promise<{locale:string}>}):Promise<Metadata>{const {locale}=await params;if(!locales.includes(locale as Locale))return{};const l=locale as Locale,path=`https://www.fixlgs.com/tools/${l}/speed-fuel-energy-converter`;return{title:meta[l].title,description:meta[l].description,alternates:{canonical:path,languages:{ko:'https://www.fixlgs.com/tools/ko/speed-fuel-energy-converter',en:'https://www.fixlgs.com/tools/en/speed-fuel-energy-converter',ja:'https://www.fixlgs.com/tools/ja/speed-fuel-energy-converter','x-default':'https://www.fixlgs.com/tools/ko/speed-fuel-energy-converter'}}}}
