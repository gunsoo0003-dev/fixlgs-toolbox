...
export async function generateMetadata({params}:{params:Promise<{locale:string}>}):Promise<Metadata>{const {locale}=await params;if(!locales.includes(locale as Locale))notFound();const l=locale as Locale;const canonical=`https://www.fixlgs.com/tools/${l}/text-diff-compare`;return{title:title[l],description:description[l],alternates:{canonical,languages:{ko:`https://www.fixlgs.com/tools/ko/text-diff-compare`,en:`https://www.fixlgs.com/tools/en/text-diff-compare`,ja:`https://www.fixlgs.com/tools/ja/text-diff-compare`,"x-default":`https://www.fixlgs.com/tools/ko/text-diff-compare`}},openGraph:{title:title[l],description:description[l],url:canonical,type:"website"}};}
