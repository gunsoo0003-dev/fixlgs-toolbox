...
export async function generateMetadata({params}:{params:Promise<{locale:string}>}):Promise<Metadata>{const {locale}=await params;if(!locales.includes(locale as Locale))return{};const l=locale as Locale,path=`https://www.fixlgs.com/tools/${l}/data-cooking-unit-converter`;return{title:meta[l].title,description:meta[l].description,alternates:{canonical:path,languages:{ko:'https://www.fixlgs.com/tools/ko/data-cooking-unit-converter',en:'https://www.fixlgs.com/tools/en/data-cooking-unit-converter',ja:'https://www.fixlgs.com/tools/ja/data-cooking-unit-converter','x-default':'https://www.fixlgs.com/tools/ko/data-cooking-unit-converter'}}}}
