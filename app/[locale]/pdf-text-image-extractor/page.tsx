...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const canonical = `https://www.fixlgs.com/tools/${l}/pdf-text-image-extractor`;
  return {
    title: titles[l], description: descriptions[l],
    alternates: { canonical, languages: { ko: "https://www.fixlgs.com/tools/ko/pdf-text-image-extractor", en: "https://www.fixlgs.com/tools/en/pdf-text-image-extractor", ja: "https://www.fixlgs.com/tools/ja/pdf-text-image-extractor", "x-default": "https://www.fixlgs.com/tools/en/pdf-text-image-extractor" } },
