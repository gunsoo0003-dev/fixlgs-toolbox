...
export async function generateMetadata({params}:{params:Promise<{locale:string}>}):Promise<Metadata>{
  ...
  const canonical=`https://www.fixlgs.com/tools/${current}/app-icon-favicon-generator`;
  return {
    ...
    alternates:{
      canonical,
      languages:{
        ko:'https://www.fixlgs.com/tools/ko/app-icon-favicon-generator',
        en:'https://www.fixlgs.com/tools/en/app-icon-favicon-generator',
        ja:'https://www.fixlgs.com/tools/ja/app-icon-favicon-generator',
        'x-default':'https://www.fixlgs.com/tools/ko/app-icon-favicon-generator',
      },
    },
  };
}
