...
export async function generateMetadata({params}:{params:Promise<{locale:string}>}):Promise<Metadata>{const {locale}=await params;if(!locales.includes(locale as Locale))return{};const l=locale as Locale,path=`https://www.fixlgs.com/tools/${l}/length-area-volume-converter`;return{title:meta[l].title,description:meta[l].description,alternates:{canonical:path,languages:{ko:'https://www.fixlgs.com/tools/ko/length-area-volume-converter',en:'https://www.fixlgs.com/tools/en/length-area-volume-converter',ja:'https://www.fixlgs.com/tools/ja/length-area-volume-converter','x-default':'https://www.fixlgs.com/tools/ko/length-area-volume-converter'}}}}
