...
export async function generateMetadata({params}:{params:Promise<{locale:string}>}):Promise<Metadata>{const {locale}=await params;if(!locales.includes(locale as Locale))return{};const l=locale as Locale,path=`https://www.fixlgs.com/tools/${l}/weight-temperature-pressure-converter`;return{title:meta[l].title,description:meta[l].description,alternates:{canonical:path,languages:{ko:'https://www.fixlgs.com/tools/ko/weight-temperature-pressure-converter',en:'https://www.fixlgs.com/tools/en/weight-temperature-pressure-converter',ja:'https://www.fixlgs.com/tools/ja/weight-temperature-pressure-converter','x-default':'https://www.fixlgs.com/tools/ko/weight-temperature-pressure-converter'}}}}
