...
export async function generateMetadata({params}:{params:Promise<{locale:string}>}):Promise<Metadata>{const {locale}=await params;if(!locales.includes(locale as Locale))return{};const l=locale as Locale,path=`https://fixlgs.com/tools/${l}/weight-temperature-pressure-converter`;return{title:meta[l].title,description:meta[l].description,alternates:{canonical:path,languages:{ko:'https://fixlgs.com/tools/ko/weight-temperature-pressure-converter',en:'https://fixlgs.com/tools/en/weight-temperature-pressure-converter',ja:'https://fixlgs.com/tools/ja/weight-temperature-pressure-converter','x-default':'https://fixlgs.com/tools/ko/weight-temperature-pressure-converter'}}}}
