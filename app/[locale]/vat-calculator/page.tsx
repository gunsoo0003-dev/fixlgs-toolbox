...
export async function generateMetadata({params}:{params:Promise<{locale:string}>}):Promise<Metadata>{const {locale}=await params;if(!locales.includes(locale as Locale))return{};const l=locale as Locale,path=`https://fixlgs.com/tools/${l}/vat-calculator`;return{title:meta[l].title,description:meta[l].description,alternates:{canonical:path,languages:{ko:'https://fixlgs.com/tools/ko/vat-calculator',en:'https://fixlgs.com/tools/en/vat-calculator',ja:'https://fixlgs.com/tools/ja/vat-calculator','x-default':'https://fixlgs.com/tools/ko/vat-calculator'}}}}
