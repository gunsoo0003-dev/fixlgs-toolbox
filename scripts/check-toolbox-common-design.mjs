...
const checks=[
  ...
  ['no-important-in-normalized-block',!globals.slice(globals.indexOf('/* Shared TOOLBOX detail-page design modifiers')).includes('!important'),'normalized common block adds no !important specificity escalation'],
];
let fail=0;
