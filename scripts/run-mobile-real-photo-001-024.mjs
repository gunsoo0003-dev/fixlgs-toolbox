...
/*
  FIXLGS TOOLBOX 001~024 Android Chrome real-photo smoke validator V20
...
}catch(e){log(`[FATAL HARNESS] ${String(e?.stack||e)}`);exitCode=2;}finally{await cleanupAndroidResources();}
