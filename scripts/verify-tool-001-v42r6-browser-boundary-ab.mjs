...
const runner=path.join(here,'run-tool-001-v42r6-browser-boundary-ab.mjs');
...
check('samsung-cdp-primary',/connectSamsungCdp/.test(s)&&/chromium\.connectOverCDP/.test(s)&&/Samsung Internet PRECISION ROUND/.test(s));
check('harness-separated',/harnessFail/.test(s)&&/HARNESS_ONLY_NO_PRODUCT_RESULT/.test(s));
