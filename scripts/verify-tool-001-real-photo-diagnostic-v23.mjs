...
const run=path.join(root,'scripts','run-tool-001-real-photo-diagnostic-v23.mjs');
...
const checks={
  version:/REAL USER PHOTO DIAGNOSTIC V23/.test(src),
...
console.log(JSON.stringify({STATIC_SELFTEST:missing.length?'FAIL':'PASS',version:'V23',missing,...checks},null,2));
