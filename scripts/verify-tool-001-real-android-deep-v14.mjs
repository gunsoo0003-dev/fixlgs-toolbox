...
const target=path.join(here,'run-tool-001-real-android-deep-v14.mjs');
...
const checks={
 ...
 no_selection_transition_false_pass:!src.includes("mode:'selection-transition'"),
