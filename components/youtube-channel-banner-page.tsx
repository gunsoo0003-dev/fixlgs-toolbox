...
export function YoutubeChannelBannerPage({ locale }: { locale: Locale }) {
  ...
  const url = `https://www.fixlgs.com/tools/${locale}/youtube-channel-banner-maker`;
