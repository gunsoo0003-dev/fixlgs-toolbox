...
export function AppStoreScreenshotMakerPage({ locale }: { locale: Locale }) {
  ...
  const url = `https://www.fixlgs.com/tools/${locale}/app-store-screenshot-maker`;
  const related = [
  ...
  const jsonLd = { "@context": "https://schema.org", "@graph": [
    ...
    { "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "TOOLBOX", item: `https://www.fixlgs.com/tools/${locale}` }, { "@type": "ListItem", position: 2, name: t.back, item: `https://www.fixlgs.com/tools/${locale}/category/content-image` }, { "@type": "ListItem", position: 3, name: t.title, item: url }] },
