...
export function HeicAvifPage({ locale }:{locale:Locale}) {
  ...
  const jsonLd = [
    {"@context":"https://schema.org","@type":"WebApplication",name:appName,applicationCategory:"MultimediaApplication",operatingSystem:"Any",offers:{"@type":"Offer",price:"0",priceCurrency:"USD"},url:`https://www.fixlgs.com/tools/${locale}/heic-avif-image-converter`,description:t.desc},
    {"@context":"https://schema.org","@type":"FAQPage",mainEntity:t.faqs.map(([q,a])=>({"@type":"Question",name:q,acceptedAnswer:{"@type":"Answer",text:a}}))},
    {"@context":"https://schema.org","@type":"BreadcrumbList",itemListElement:[{"@type":"ListItem",position:1,name:"TOOLBOX",item:`https://www.fixlgs.com/tools/${locale}`},{"@type":"ListItem",position:2,name:t.back,item:`https://www.fixlgs.com/tools/${locale}/category/image-convert`},{"@type":"ListItem",position:3,name:appName,item:`https://www.fixlgs.com/tools/${locale}/heic-avif-image-converter`}]}
  ];
  ...
  return <ToolboxSubpageShell locale={locale} appName={appName}><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(jsonLd)}}/>
    ...
    <section className="toolbox-tool-detail-body"><div><HeicAvifConverterTool locale={locale}/>
      <ToolNavigation locale={locale} currentTool={2} />
