...
export function BeforeAfterImagePage({locale}:{locale:Locale}){
  ...
  const url=`https://www.fixlgs.com/tools/${locale}/before-after-image-maker`;
  const jsonLd={"@context":"https://schema.org","@graph":[
    ...
    {"@type":"BreadcrumbList",itemListElement:[{"@type":"ListItem",position:1,name:"TOOLBOX",item:`https://www.fixlgs.com/tools/${locale}`},{"@type":"ListItem",position:2,name:t.back,item:`https://www.fixlgs.com/tools/${locale}/category/image-edit`},{"@type":"ListItem",position:3,name:appName,item:url}]},
