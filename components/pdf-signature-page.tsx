...
const copy = {
  ko: {
    ...
    related: "관련 도구", next: "다음 작업", available: "사용 가능",
  },
  en: {
    ...
    related: "Related tools", next: "Next work", available: "AVAILABLE",
  },
  ja: {
    ...
    related: "関連ツール", next: "次の作業", available: "利用可能",
  },
} as const;

export function PdfSignaturePage({ locale }: { locale: Locale }) {
  const t = copy[locale];
  const url = `https://www.fixlgs.com/tools/${locale}/pdf-signature`;
  const jsonLd = { "@context": "https://schema.org", "@graph": [
    ...
    { "@type": "BreadcrumbList", itemListElement: [
      { "@type": "ListItem", position: 1, name: "TOOLBOX", item: `https://www.fixlgs.com/tools/${locale}` },
      { "@type": "ListItem", position: 2, name: t.back, item: `https://www.fixlgs.com/tools/${locale}/category/pdf` },
