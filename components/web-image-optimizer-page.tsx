  ...
  const jsonLd = [
    {
      ...
      url: `https://www.fixlgs.com/tools/${locale}/web-image-optimizer`,
      description: t.desc,
    },
    {
      "@context": "https://schema.org",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: t.title, item: `https://www.fixlgs.com/tools/${locale}/web-image-optimizer` },
      ],
    },
  ];
